...
Carro = db.define_table('carro',
    Field('marca', 'string', widget = lambda field, value:
    SQLFORM.widgets.string.widget(field, value, _class='validate')),
    Field('modelo', 'string', widget = lambda field, value:
    SQLFORM.widgets.string.widget(field, value, _class='validate')),
    Field('placa', 'string', widget = lambda field, value:
    SQLFORM.widgets.string.widget(field, value, _class='validate')),
    Field('ano', 'string', widget = lambda field, value:
    SQLFORM.widgets.string.widget(field, value, _class='validate')),
    format = "%(modelo)s / %(placa)s"
    )
...
Manutencao = db.define_table('manutencao',
    ...
    SQLFORM.widgets.string.widget(field, value, _class='validate')),
    Field('ocorrencia', 'text'),
    Field('notafiscal', 'upload'),
    )
